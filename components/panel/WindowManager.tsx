      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, #0a0a0a 0%, #2a2a2a 15%, #3a3a3a 30%, #4a4a4a 50%, #3a3a3a 70%, #2a2a2a 85%, #0a0a0a 100%)",
            boxShadow:
              "inset 2px 0 3px rgba(0,0,0,0.9), inset -2px 0 3px rgba(0,0,0,0.9), 0 0 8px rgba(0,0,0,0.5)",
            borderRadius: "2px",
          }}
        >
          {/* Top cap - rounded metal end */}
          <div
            className="absolute top-0 right-0 left-0 h-3 rounded-t-sm"
            style={{
              background: "linear-gradient(180deg, #3a3a3a 0%, #2a2a2a 50%, transparent 100%)",
            }}
          />
          {/* Bottom cap - rounded metal end */}
          <div
            className="absolute right-0 bottom-0 left-0 h-3 rounded-b-sm"
            style={{
              background: "linear-gradient(0deg, #2a2a2a 0%, #1a1a1a 50%, transparent 100%)",
            }}
          />
          {/* Center highlight */}
