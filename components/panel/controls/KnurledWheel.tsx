...
export function KnurledWheel({
  ...
  return (
    <div className={cn("flex flex-col items-center gap-0.5", className)}>
      {label && <span className="font-mono text-[5px] text-white/40 uppercase">{label}</span>}
      ...
      <div
        ...
        className={cn(
          "relative cursor-ns-resize overflow-hidden rounded-sm select-none",
          wheelWidth,
          wheelHeight,
        ...
        style={{
          background:
            "linear-gradient(90deg, #1a1a2a 0%, #2a2a3a 20%, #3a3a4a 50%, #2a2a3a 80%, #1a1a2a 100%)",
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.1) 40%, rgba(255,255,255,0.15) 50%, rgba(255,255,255,0.1) 60%, transparent 100%)",
          }}
        />
