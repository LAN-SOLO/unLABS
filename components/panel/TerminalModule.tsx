...
function Screw({ className }: { className?: string }) {
  return (
    <div
      className={cn("relative flex h-4 w-4 items-center justify-center rounded-full", className)}
      style={{
        background:
          "radial-gradient(circle at 40% 35%, #a8acb2 0%, #8a8e94 20%, #6e7278 45%, #555960 70%, #484c52 100%)",
        boxShadow:
          "inset 0 1px 2px rgba(255,255,255,0.25), inset 0 -1px 1px rgba(0,0,0,0.3), 0 1px 3px rgba(0,0,0,0.6), 0 0 0 0.5px #33373d",
      }}
    >
      ...
      {/* Phillips cross slot */}
      <div
        className="absolute h-[1.5px] w-[7px] rounded-[0.5px]"
        style={{
      ...
      />
      <div
        className="absolute h-[7px] w-[1.5px] rounded-[0.5px]"
        style={{
  ...
  return (
    <div className={cn("flex gap-0.5", vertical ? "flex-col" : "flex-row")}>
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className={cn("rounded-sm bg-[#2a2e34]", vertical ? "h-0.5 w-3" : "h-3 w-0.5")}
        />
      ))}
    </div>
  );
...
function StatusTicker() {
  ...
  return (
    <div
      className="relative h-5 w-[280px] overflow-hidden rounded"
      style={{
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent 0px, transparent 1px, rgba(0,255,100,0.03) 1px, rgba(0,255,100,0.03) 2px)",
        }}
      />
...
function OsBootSequence({
  ...
  return (
    <div
      className="absolute inset-0 z-40 overflow-hidden rounded bg-black"
      style={{
        opacity: fading ? 0 : 1,
    ...
    >
      ...
      {phase === "logo" && (
        ...
        >
          ...
          <div
            ...
            style={{ color: `${theme.fg}88` }}
          >
            v4.2.1 &middot; quantum-core
          </div>
          {/* Subtitle */}
          <div
            className="mt-1 font-mono text-[7px] tracking-[0.25em]"
            style={{ color: `${theme.fg}55` }}
          >
            UNSTABLE LABORATORIES
          </div>
          {/* Loading bar */}
          <div
            className="mt-3 h-[2px] w-24 overflow-hidden rounded"
      ...
      {(phase === "lines" || phase === "fade") && (
        <div className="overflow-hidden p-3 font-mono text-[9px] leading-[13px]">
          ...
          {!fading && visibleLines > 0 && (
            <span
              className="mt-0.5 inline-block h-[10px] w-[6px]"
              style={{
...
function PowerMenu({
  ...
  return (
    <div
      ref={menuRef}
      className="absolute z-[100] flex flex-col gap-0.5 rounded-md border border-white/15 p-1.5"
      style={{
        left: pos.left,
        bottom: pos.bottom,
    ...
    >
      <button
        className="flex cursor-pointer items-center gap-2 rounded px-3 py-1.5 text-left transition-colors hover:bg-white/15"
        onMouseDown={(e) => {
          e.stopPropagation();
          onReboot();
        }}
      >
        ...
        <span className="font-mono text-[11px] whitespace-nowrap text-white/90">Reboot _unOS</span>
      </button>
      <button
        className="flex cursor-pointer items-center gap-2 rounded px-3 py-1.5 text-left transition-colors hover:bg-white/15"
        onMouseDown={(e) => {
      ...
      >
        ...
        <span className="font-mono text-[11px] whitespace-nowrap text-white/90">
          Shutdown _unOS
        </span>
      </button>
...
export function TerminalModule({ userId, username, balance, className }: TerminalModuleProps) {
  ...
  return (
    <div ref={rootRef} className={cn("relative h-full w-full", className)}>
      ...
      >
        {/* Top bezel section */}
        <div
          className="flex h-8 items-center justify-between border-b border-[#484c52] px-3"
          style={{
            backgroundImage: `
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-mono text-[8px] font-bold tracking-wider text-[#8a8a8a]">
                UNSTABLE
              </span>
          ...
          <div className="absolute left-1/2 flex -translate-x-1/2 items-center gap-2">
            <div
              className="rounded border border-[#0a0a0a] bg-[#1a1a1a] px-3 py-0.5"
              style={{ boxShadow: "inset 0 1px 3px rgba(0,0,0,0.8)" }}
            >
              <span className="font-mono text-[9px] tracking-widest text-[var(--neon-green)]">
                _unOS TERMINAL
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <div className="flex flex-col items-center">
                ...
                />
                <span className="mt-0.5 font-mono text-[5px] text-[#5a5a5a]">PWR</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="h-2 w-2 rounded-full bg-[var(--neon-amber)] shadow-[0_0_6px_var(--neon-amber)]" />
                <span className="mt-0.5 font-mono text-[5px] text-[#5a5a5a]">HDD</span>
              </div>
            </div>
            <VentHoles count={6} />
            {screwManager ? (
        ...
        <div className="absolute top-8 right-3 bottom-10 left-3">
          ...
          >
            ...
            <div
              ref={screenRef}
              className={cn(
                "relative h-full w-full overflow-hidden rounded transition-colors duration-500",
            ...
            >
              ...
              <div
                className="pointer-events-none absolute right-0 left-0 z-10 h-[2px] opacity-15"
                style={{
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="flex gap-1">
                    <div className="h-1.5 w-1.5 rounded-full bg-[var(--neon-red)]/60" />
                    <div className="h-1.5 w-1.5 rounded-full bg-[var(--neon-amber)]/60" />
                    <div
                      className="h-1.5 w-1.5 rounded-full"
                      style={{ background: `${theme.fg}99` }}
                    />
                  </div>
                  <span
                ...
                <div className="flex items-center gap-1">
                  ...
                  />
                  <span
                    className="font-mono text-[7px] transition-colors duration-500"
              ...
              {/* Terminal content */}
              <div
                className="relative z-[1] flex h-[calc(100%-44px)] flex-col overflow-hidden p-2 transition-colors duration-500"
                style={
                  {
                    "--tw-text-opacity": "1",
                    color: theme.fg,
                ...
                <div
                  ...
                  style={{
                    filter:
                      themeIndex === 0
                        ? "none"
                        : `hue-rotate(${getHueShift(themeIndex)}deg) saturate(${getSaturation(themeIndex)})`,
                  }}
                >
                  <Terminal
                    key={rebootKey}
              ...
              {/* Terminal status bar */}
              <div
                className="relative z-[1] flex items-center justify-between px-2 py-0.5 font-mono text-[8px] transition-colors duration-500"
            ...
            {/* OS off overlay */}
            {osOff && (
              <div className="absolute inset-0 z-40 flex items-center justify-center rounded bg-black">
            ...
            {/* OS boot sequence */}
            {osBooting && <OsBootSequence theme={theme} onComplete={handleBootComplete} />}
          </div>
        </div>

        {/* Bottom bezel section */}
        <div
          className="absolute right-0 bottom-0 left-0 flex h-10 items-center justify-between border-t border-[#6a6f76] px-3"
          style={{
            backgroundImage: `
              repeating-linear-gradient(0deg, transparent 0px, rgba(255,255,255,0.035) 1px, transparent 2px, transparent 4px),
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="rounded border border-[#33373d] bg-[#3a3e44] px-2 py-0.5">
            ...
            <div className="relative flex flex-col items-center">
              <button
                ...
                onClick={() => {
                  ...
                  if (osOff) {
                    ...
                    systemPower.systemState === "running" ||
                    systemPower.systemState === "countdown"
                  ) {
                    setPowerMenuOpen((prev) => !prev);
                  }
                }}
                className="flex h-6 w-6 cursor-pointer items-center justify-center rounded-full transition-transform active:scale-95"
                style={{
                  background:
                    "radial-gradient(circle at 40% 35%, #3a3e44 0%, #2a2e34 40%, #1a1e24 80%, #0a0e14 100%)",
                  boxShadow:
                    "inset 0 2px 4px rgba(0,0,0,0.8), inset 0 -1px 1px rgba(255,255,255,0.05), 0 1px 2px rgba(0,0,0,0.6), 0 0 0 1px #33373d",
                }}
              ...
              >
                <div className="relative h-3 w-3">
                  ...
                  />
                  <div
                    className="absolute top-0 left-1/2 h-[5px] w-[1.5px] -translate-x-1/2 rounded-full"
                    style={{
                      background: osOff
                        ? "#555960"
                        : osCrtActive
              ...
              <span className="mt-0.5 font-mono text-[4px] text-[#8a8e94]">PWR</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col items-center">
                <button
                  onClick={cycleTheme}
                  className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-full border transition-all hover:brightness-110 active:brightness-90"
                  style={{
                ...
                >
                  <div
                    ...
                    style={{ background: theme.fg, boxShadow: `0 0 3px ${theme.fg}` }}
                  />
                </button>
                <span className="mt-0.5 font-mono text-[4px] text-[#8a8e94]">CLR</span>
              </div>
              <div className="flex flex-col items-center">
                <button
                  onClick={resetTheme}
                  ...
                  title="Reset theme"
                >
                  <div className="h-[1px] w-1.5 rounded-full bg-[#a0a4aa]" />
                </button>
                <span className="mt-0.5 font-mono text-[4px] text-[#8a8e94]">RST</span>
              </div>
            </div>
            <VentHoles count={4} vertical />
            {screwManager ? (
      ...
      {powerMenuOpen && (
        <PowerMenu
          onReboot={() => {
            systemPower?.rebootNow("os");
            setPowerMenuOpen(false);
          }}
          onShutdown={() => {
            systemPower?.shutdownNow("os");
            setPowerMenuOpen(false);
          }}
