      ...
      >
        ...
        <div className="flex flex-col gap-1 p-2">
          ...
          {systemState === "countdown" && (
            <button
              className="w-full rounded px-3 py-1.5 text-left transition-colors hover:bg-white/5"
          ...
          {systemState !== "countdown" && (
            <>
              ...
              <div className="my-1 h-px" style={{ background: "rgba(255, 184, 0, 0.1)" }} />

              {/* Schedule shutdown */}
              {scheduleMode === "shutdown" ? (
                <div className="px-3 py-1.5">
                  <div className="mb-1 text-[9px]" style={{ color: "rgba(255, 184, 0, 0.5)" }}>
                  ...
                  <div className="flex gap-1">
                    <input
                      ...
                      className="flex-1 rounded bg-black/50 px-2 py-1 font-mono text-xs outline-none"
                      style={{
                  ...
                  {error && (
                    <div className="mt-1 text-[9px]" style={{ color: "var(--neon-red, #ff3333)" }}>
                      {error}
                    </div>
                  )}
                </div>
        ...
        {/* Footer hint */}
        <div
          className="px-3 py-1.5 text-center text-[8px]"
          style={{
