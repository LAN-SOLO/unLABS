...
export function PowerButton() {
  ...
  const getLedColor = () => {
    switch (systemState) {
      case "running":
        return "var(--neon-green, #00ff66)";
      case "countdown":
        return "var(--neon-amber, #ffb800)";
      case "shutting-down":
      case "rebooting":
        return "var(--neon-red, #ff3333)";
      case "booting":
        return "var(--neon-cyan, #00e5ff)";
      case "off":
  ...
  const getAnimation = () => {
    switch (systemState) {
      case "countdown":
        return "power-pulse 1.5s ease-in-out infinite";
      case "shutting-down":
      case "rebooting":
        return "power-pulse 0.4s ease-in-out infinite";
      case "booting":
        return "power-pulse 2s ease-in-out infinite";
      default:
        return "none";
    }
  };
  ...
  const isDisabled =
    systemState === "shutting-down" || systemState === "rebooting" || systemState === "booting";
  ...
  return (
    <>
      <div className="relative flex items-center gap-1.5">
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              systemState !== "off" ? `0 0 6px ${ledColor}40, inset 0 0 4px ${ledColor}20` : "none",
        ...
        >
          ...
          >
            <path d="M6 1.5V5.5" stroke={ledColor} strokeWidth="1.5" strokeLinecap="round" />
            <path
      ...
      {/* Power menu overlay */}
      {menuOpen && <PowerMenu onClose={() => setMenuOpen(false)} />}
    </>
  );
}
