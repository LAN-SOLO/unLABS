...
const LANDING_BOOT_LINES = [
  ...
  { text: "", delay: 40 },
  { text: "┌──────────────────────────────────────────────────────────┐", delay: 50 },
  { text: "│                   FILESYSTEM MOUNT                       │", delay: 50 },
  { text: "└──────────────────────────────────────────────────────────┘", delay: 80 },
  { text: "", delay: 40 },
  { text: "[MOUNT] /unfs (root)................. ext4     [MOUNTED]", delay: 80 },
  { text: "[MOUNT] /unboot...................... ext4     [MOUNTED]", delay: 80 },
  { text: "[MOUNT] /unsys....................... sysfs    [MOUNTED]", delay: 80 },
  { text: "[MOUNT] /unproc...................... procfs   [MOUNTED]", delay: 80 },
  { text: "[MOUNT] /undev....................... devtmpfs [MOUNTED]", delay: 80 },
  { text: "[BLOCK] unsda: 64GB NVMe SSD........ 253:0    [  OK  ]", delay: 80 },
  { text: "[BLOCK] unsdb: 128GB Data Disk...... 253:16   [  OK  ]", delay: 80 },
  { text: "", delay: 40 },
  { text: "┌──────────────────────────────────────────────────────────┐", delay: 50 },
  ...
  { text: "", delay: 40 },
  { text: "┌──────────────────────────────────────────────────────────┐", delay: 50 },
  { text: "│                  SYSTEM SERVICES                         │", delay: 50 },
  { text: "└──────────────────────────────────────────────────────────┘", delay: 80 },
  { text: "", delay: 40 },
  { text: "[SVC] systemd-journald............... Active  [  OK  ]", delay: 80 },
  { text: "[SVC] systemd-networkd............... Active  [  OK  ]", delay: 80 },
  { text: "[SVC] cron........................... Active  [  OK  ]", delay: 80 },
  { text: "[SVC] und (system daemon)............ Active  [  OK  ]", delay: 80 },
  { text: "[SVC] undev (device manager)......... Active  [  OK  ]", delay: 80 },
  { text: "[SVC] unnet (network manager)........ Active  [  OK  ]", delay: 80 },
  { text: "[SVC] untick (tick engine)........... Active  [  OK  ]", delay: 80 },
  { text: "[SVC] unchain (blockchain)........... Active  [  OK  ]", delay: 80 },
  { text: "[SVC] unpod (containers)............. Active  [  OK  ]", delay: 80 },
  { text: "", delay: 40 },
  { text: "[SHELL] Environment: 12 variables loaded", delay: 80 },
  { text: "[SHELL] Utilities: 147 commands registered", delay: 80 },
  { text: "", delay: 40 },
  { text: "╔════════════════════════════════════════════════════════════╗", delay: 50 },
...
const LOGIN_BOOT_LINES = [
  ...
  { text: "", delay: 40 },
  { text: "[AUTH] Verifying system services...", delay: 100 },
  { text: "[AUTH] Journal daemon................. Running [  OK  ]", delay: 80 },
  { text: "[AUTH] Network daemon................. Running [  OK  ]", delay: 80 },
  { text: "[AUTH] Cron scheduler................. Running [  OK  ]", delay: 80 },
  { text: "[AUTH] Shell environment.............. Loaded  [  OK  ]", delay: 80 },
  { text: "", delay: 40 },
  { text: "┌──────────────────────────────────────────────────────────┐", delay: 50 },
...
export function BootSequence({ onComplete, variant = "landing", className }: BootSequenceProps) {
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 z-50 flex items-start justify-center overflow-hidden bg-black pt-20",
        isComplete && "animate-fade-out",
        className,
      )}
    >
      <div className="w-full max-w-3xl px-8 font-mono text-sm">
        <div className="leading-relaxed text-[var(--neon-green)]">
          ...
          {!isComplete && (
            <span className="ml-1 inline-block h-4 w-2 animate-pulse bg-[var(--neon-green)]" />
          )}
        </div>
      </div>
