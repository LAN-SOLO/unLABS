...
export function ActiveSynergyCard({
  combo,
  currentDeviceId,
  onUnlink,
  linking,
}: ActiveSynergyCardProps) {
  return (
    <div className="space-y-0.5 py-1 font-mono text-[10px]">
      ...
      <div className="pl-4">
        <button
          ...
          disabled={linking}
          className="cursor-pointer text-red-400/50 hover:text-red-400 disabled:text-green-500/20"
        >
