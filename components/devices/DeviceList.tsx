...
const HEADER_LINE =
  "╔══════════╦═══════════════════════════╦═══════╦═════════╦══════════════╦══════╦═══════╗";
const HEADER_ROW =
  "║ ID       ║ DEVICE                    ║ TIER  ║ STATUS  ║ POWER        ║ CAT  ║ HEALTH║";
const HEADER_DIV =
  "╠══════════╬═══════════════════════════╬═══════╬═════════╬══════════════╬══════╬═══════╣";
const FOOTER_LINE =
  "╚══════════╩═══════════════════════════╩═══════╩═════════╩══════════════╩══════╩═══════╝";
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="overflow-x-auto">
        <div className="min-w-fit font-mono text-[10px] leading-[18px] whitespace-pre select-none">
          {/* Table header */}
          ...
          {/* Loading state */}
          {loading && (
            <div className="px-2 py-2 text-green-500/40">
          ...
          {!loading && items.length === 0 && (
            <div className="px-2 py-2 text-green-500/40">║ NO DEVICES MATCH CURRENT FILTERS</div>
          )}
      ...
      {/* Footer info */}
      {!loading && (
        <div className="flex justify-between font-mono text-[9px] text-green-500/40">
          <span>
            {filteredCount} device{filteredCount !== 1 ? "s" : ""} listed
          </span>
