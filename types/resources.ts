...
export const RESOURCE_CONTAINERS: ResourceContainerDef[] = [
  // Tier 0 - Starter
  {
    id: "SPC-000",
    name: "Seep Collector",
    resourceType: "Abstractum",
    tier: 0,
    capacity: 500,
    upgradesTo: "ATK-001",
    color: "var(--neon-green)",
    icon: "◈",
    upgradeMaterial: "abstractum",
  },
  {
    id: "RSC-000",
    name: "Residual Cell",
  ...
  },
  {
    ...
    icon: "⚡",
    replaces: "RSC-000",
    upgradeMaterial: "power_cells",
  },
  {
    id: "BIN-101",
    name: "Alloy Bin",
    resourceType: "Base Alloy",
    tier: 1,
    capacity: 500,
    upgradesTo: "BIN-201",
    color: "var(--neon-amber)",
    icon: "⬡",
    autoCreatedWith: "SMT-001",
    upgradeMaterial: "base_alloy",
  },
  {
    id: "VAT-102",
    name: "Chemical Vat",
    resourceType: "Basic Chemical",
    tier: 1,
    capacity: 500,
    upgradesTo: "VAT-202",
    color: "var(--neon-purple)",
    icon: "⬢",
    autoCreatedWith: "CHM-001",
    upgradeMaterial: "basic_chemical",
  },
  {
    id: "CRK-103",
    name: "Cell Rack",
    resourceType: "Power Cells",
    tier: 1,
    capacity: 200,
    upgradesTo: "CRK-203",
    color: "#ff6e40",
    icon: "▣",
    autoCreatedWith: "ENC-001",
    upgradeMaterial: "power_cells",
  },
  // Tier 2 - Advanced
  {
    id: "BIN-201",
    name: "Alloy Vault",
    resourceType: "Adv. Alloy",
    tier: 2,
    capacity: 1000,
    upgradesTo: "BIN-301",
    color: "var(--neon-amber)",
    icon: "⬡",
    autoCreatedWith: "ALF-001",
    upgradeMaterial: "base_alloy",
  },
  {
    id: "ARY-202",
    name: "Crystal Array",
    resourceType: "Res. Crystals",
    tier: 2,
    capacity: 200,
    upgradesTo: "ARY-302",
    color: "#00e5ff",
    icon: "◎",
    autoCreatedWith: "CRS-001",
    upgradeMaterial: "base_alloy",
  },
  {
    id: "SIL-203",
    name: "Element Silo",
    resourceType: "Rare Elements",
    tier: 2,
    capacity: 300,
    upgradesTo: "SIL-303",
    color: "#ffd740",
    icon: "⊙",
    autoCreatedWith: "EXP-001",
    upgradeMaterial: "abstractum",
  },
  // Tier 3 - Exotic
  {
    id: "BIN-301",
    name: "Nano-Container",
    resourceType: "Nanomaterial",
    tier: 3,
    capacity: 500,
    upgradesTo: "BIN-401",
    color: "#b388ff",
    icon: "⬡",
    autoCreatedWith: "NFB-001",
    upgradeMaterial: "advanced_alloy",
  },
  {
    id: "EMC-302",
    name: "Exotic Containment",
    ...
    color: "var(--neon-pink)",
    icon: "✧",
    autoCreatedWith: "RRF-001",
    upgradeMaterial: "advanced_alloy",
  },
  {
    id: "FLK-303",
    name: "Antimatter Flask",
  ...
  // Tier 4 - Quantum
  {
    id: "BIN-401",
    name: "Quantum Vault",
    resourceType: "Any Element",
    tier: 4,
    capacity: 300,
    upgradesTo: null,
    color: "#b388ff",
    icon: "◇",
    autoCreatedWith: "QTF-001",
    upgradeMaterial: "nanomaterial",
  },
  {
    id: "TUB-402",
    name: "Memetic Reservoir",
    resourceType: "Ideoplasm",
    tier: 4,
    capacity: 200,
    upgradesTo: null,
    color: "#ea80fc",
    icon: "◬",
    autoCreatedWith: "MMF-001",
    upgradeMaterial: "nanomaterial",
  },
  {
    id: "COR-403",
    name: "Anomaly Cage",
    resourceType: "Anomaly Cores",
    tier: 4,
    capacity: 20,
    upgradesTo: null,
    color: "#ff5252",
    icon: "⊗",
    autoCreatedWith: "ANF-001",
    upgradeMaterial: "nanomaterial",
  },
  // Tier 5 - Stellar
  {
    id: "FRG-501",
    name: "Stellar Vault",
    resourceType: "Heavy Elements",
    tier: 5,
    capacity: 1000,
    upgradesTo: null,
    color: "#8d6e63",
    icon: "★",
    autoCreatedWith: "STF-001",
    upgradeMaterial: "exotic_matter",
  },
  {
    id: "SOL-502",
    name: "Solvent Tank",
    resourceType: "Universal Fixer",
    tier: 5,
    capacity: 50,
    upgradesTo: null,
    color: "#e0e0e0",
