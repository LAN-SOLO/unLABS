...
export function CLKManagerProvider({ children, initialState }: CLKManagerProviderProps) {
  ...
  const [deviceState, setDeviceState] = useState<CLKDeviceState>(
  ...
  const runTest = useCallback(async () => {
    ...
    const phases: NonNullable<CLKTestPhase>[] = [
      "crystal",
      "sync",
      "drift",
      "accuracy",
  ...
  return <CLKManagerContext.Provider value={value}>{children}</CLKManagerContext.Provider>;
}
