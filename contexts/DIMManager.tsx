...
export function DIMManagerProvider({ children, initialState }: DIMManagerProviderProps) {
  ...
  const [deviceState, setDeviceState] = useState<DIMDeviceState>(
  ...
  const runTest = useCallback(async () => {
    ...
    const phases: NonNullable<DIMTestPhase>[] = [
      "sensors",
      "rift-scan",
      "stability",
      "calibration",
  ...
  return <DIMManagerContext.Provider value={value}>{children}</DIMManagerContext.Provider>;
}
