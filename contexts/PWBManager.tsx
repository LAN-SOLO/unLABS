...
export function PWBManagerProvider({ children, initialState }: PWBManagerProviderProps) {
  ...
  const [deviceState, setDeviceState] = useState<PWBDeviceState>(
  ...
  const runTest = useCallback(async () => {
    ...
    const phases: NonNullable<PWBTestPhase>[] = [
      "motors",
      "clamps",
      "sensors",
      "calibrate",
  ...
  return <PWBManagerContext.Provider value={value}>{children}</PWBManagerContext.Provider>;
}
