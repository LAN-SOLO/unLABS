...
export function TMPManagerProvider({ children, initialState }: TMPManagerProviderProps) {
  ...
  const [deviceState, setDeviceState] = useState<TMPDeviceState>(
  ...
  const runTest = useCallback(async () => {
    ...
    const phases: NonNullable<TMPTestPhase>[] = [
      "sensors",
      "calibration",
      "threshold",
      "cooling",
  ...
  return <TMPManagerContext.Provider value={value}>{children}</TMPManagerContext.Provider>;
}
