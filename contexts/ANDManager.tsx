...
export function ANDManagerProvider({ children, initialState }: ANDManagerProviderProps) {
  ...
  const [deviceState, setDeviceState] = useState<ANDDeviceState>(
  ...
  const runTest = useCallback(async () => {
    ...
    const phases: NonNullable<ANDTestPhase>[] = [
      "sensors",
      "calibrate",
      "sweep",
      "analyze",
  ...
  return <ANDManagerContext.Provider value={value}>{children}</ANDManagerContext.Provider>;
}
