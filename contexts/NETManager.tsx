...
export function NETManagerProvider({ children, initialState }: NETManagerProviderProps) {
  ...
  const [deviceState, setDeviceState] = useState<NETDeviceState>(
  ...
  const runTest = useCallback(async () => {
    ...
    const phases: NonNullable<NETTestPhase>[] = [
      "latency",
      "bandwidth",
      "packet",
      "security",
  ...
  return <NETManagerContext.Provider value={value}>{children}</NETManagerContext.Provider>;
}
