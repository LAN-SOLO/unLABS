...
export const DEFAULT_MODULES: {
  ...
  {
    name: "unfs",
    description: "_unOS Virtual Filesystem",
    version: "2.0.0",
    size: 1024,
    dependencies: [],
  },
  {
    name: "unnet",
    description: "_unOS Network Stack",
    version: "2.0.0",
    size: 768,
    dependencies: [],
  },
  {
    name: "undev",
    description: "_unOS Device Framework",
    version: "2.0.0",
    size: 512,
    dependencies: [],
  },
  {
    name: "uncrypto",
    description: "_unOS Cryptographic Subsystem",
    version: "1.4.0",
    size: 384,
    dependencies: [],
  },
  {
    name: "unquantum",
    description: "Quantum Processing Module",
    version: "3.1.0",
    size: 2048,
    dependencies: ["uncrypto"],
  },
  {
    name: "unsound",
  ...
  {
    name: "uncrystal",
    description: "Crystal Interface Driver",
    version: "2.0.0",
    size: 1536,
    dependencies: ["undev", "unfs"],
  },
  {
    name: "uncontain",
    description: "Container Runtime Module",
    version: "1.0.0",
    size: 896,
    dependencies: ["unfs", "unnet"],
  },
];
...
export const DAEMON_PROCESSES: {
  ...
  {
    name: "crystal-engine",
    cmdline: "/unusr/bin/crystal-engine --daemon",
    uid: 1001,
    memoryRSS: 65536,
    memoryVSZ: 131072,
    tty: "?",
  ...
  },
  {
    ...
    cmdline: "/unusr/bin/blockchain-sync --chain=solana",
    uid: 1001,
    memoryRSS: 32768,
    memoryVSZ: 65536,
    tty: "?",
  ...
  {
    name: "device-monitor",
    cmdline: "/unusr/bin/device-monitor --all",
    uid: 0,
    memoryRSS: 16384,
    memoryVSZ: 32768,
    tty: "?",
  ...
  {
    name: "tick-engine",
    cmdline: "/unusr/bin/tick-engine --interval=2000",
    uid: 1001,
    memoryRSS: 8192,
    memoryVSZ: 16384,
    tty: "?",
  ...
  },
  {
    ...
    cmdline: "/unusr/bin/volatility-tracker --tps",
    uid: 1001,
    memoryRSS: 12288,
    memoryVSZ: 24576,
    tty: "?",
  ...
  },
  {
    ...
    cmdline: "/unusr/bin/unpod-runtime",
    uid: 0,
    memoryRSS: 24576,
    memoryVSZ: 49152,
    tty: "?",
  ...
  },
  {
    ...
    cmdline: "/unusr/bin/quantum-monitor --qubits=127",
    uid: 1001,
    memoryRSS: 16384,
    memoryVSZ: 32768,
    tty: "?",
  ...
  {
    name: "kworker/0:1",
    cmdline: "[kworker/0:1-mm_percpu_wq]",
    uid: 0,
    memoryRSS: 512,
    memoryVSZ: 1024,
    tty: "?",
