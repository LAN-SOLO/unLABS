...
const DEVICE_SPECS: DeviceSpec[] = [
  {
    id: "UEC-001",
    name: "Universal Energy Controller",
    category: "power",
    version: "3.2.1",
    power: { fullLoad: 0, idle: 0, standby: 0 },
  },
  {
    id: "MFR-001",
    ...
    category: "power",
    version: "2.8.0",
    power: { fullLoad: -200, idle: -150, standby: -50 },
  },
  {
    id: "BAT-001",
    name: "Battery Array",
    category: "power",
    version: "1.5.3",
    power: { fullLoad: -100, idle: -80, standby: -20 },
  },
  {
    id: "CDC-001",
    ...
    category: "crystal",
    version: "4.1.0",
    power: { fullLoad: 15, idle: 8, standby: 1 },
  },
  {
    id: "HMS-001",
    name: "Harmonic Sound System",
    category: "audio",
    version: "2.0.1",
    power: { fullLoad: 8, idle: 4, standby: 1 },
  },
  {
    id: "ECR-001",
    name: "Echo Resonator",
    category: "audio",
    version: "1.3.0",
    power: { fullLoad: 6, idle: 3, standby: 1 },
  },
  {
    id: "IPL-001",
    ...
    category: "compute",
    version: "3.0.2",
    power: { fullLoad: 20, idle: 10, standby: 2 },
  },
  {
    id: "AIC-001",
    ...
    category: "compute",
    version: "5.1.0",
    power: { fullLoad: 30, idle: 15, standby: 3 },
  },
  {
    id: "VNT-001",
    ...
    category: "field",
    version: "1.1.0",
    power: { fullLoad: 5, idle: 3, standby: 1 },
  },
  {
    id: "SCA-001",
    ...
    category: "compute",
    version: "2.4.1",
    power: { fullLoad: 45, idle: 20, standby: 5 },
  },
  {
    id: "EXD-001",
    name: "Exotic Matter Detector",
    category: "field",
    version: "2.2.0",
    power: { fullLoad: 18, idle: 9, standby: 2 },
  },
  {
    id: "QSM-001",
    ...
    category: "quantum",
    version: "1.2.0",
    power: { fullLoad: 12, idle: 7, standby: 1 },
  },
  {
    id: "EMC-001",
    ...
    category: "quantum",
    version: "4.0.1",
    power: { fullLoad: 40, idle: 18, standby: 2 },
  },
  {
    id: "QUA-001",
    ...
    category: "quantum",
    version: "3.7.2",
    power: { fullLoad: 25, idle: 10, standby: 2 },
  },
];
...
export class DeviceManager {
  ...
  runTest(id: string): { success: boolean; message: string; results?: Record<string, string> } {
    ...
    if (device.state !== "online")
      return { success: false, message: `${id} must be online to test` };
