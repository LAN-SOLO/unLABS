...
export class VirtualFS {
  ...
  private buildDefaultTree(): VirtualNode {
    ...
    this.addChild(
      etcUnos,
      this.mknode("blockchain.conf", "file", {
        content: [
    ...
    // /home/operator
    const opHome = this.addChild(
      home,
      this.mknode("operator", "dir", { owner: "operator", group: "operator", permissions: 0o750 }),
    );
    this.addChild(
      opHome,
      this.mknode(".bashrc", "file", {
        owner: "operator",
        group: "operator",
        content:
    ...
    const opLocal = this.addChild(
      opHome,
      this.mknode(".local", "dir", { owner: "operator", group: "operator" }),
    );
    const opLocalDocs = this.addChild(
      opLocal,
      this.mknode("docs", "dir", { owner: "operator", group: "operator" }),
    );
    this.addChild(
      opLocalDocs,
      this.mknode("emc001.txt", "file", {
        owner: "operator",
        group: "operator",
        content: [
          "═══════════════════════════════════════════════════════════",
    ...
    this.addChild(
      opLocalDocs,
      this.mknode("screwbuttons.txt", "file", {
        owner: "operator",
        group: "operator",
        content: [
          "═══════════════════════════════════════════════════════════",
    ...
    const opCrystals = this.addChild(
      opHome,
      this.mknode("crystals", "dir", { owner: "operator", group: "operator" }),
    );
    this.addChild(
      opCrystals,
      this.mknode(".gitkeep", "file", { owner: "operator", group: "operator", content: "" }),
    );
    const opScripts = this.addChild(
      opHome,
      this.mknode("scripts", "dir", { owner: "operator", group: "operator" }),
    );
    this.addChild(
      opScripts,
      this.mknode("scan.sh", "file", {
        owner: "operator",
        group: "operator",
        permissions: 0o755,
        content:
    ...
    // /home/adm
    const admHome = this.addChild(
      home,
      this.mknode("adm", "dir", { owner: "adm", group: "adm", permissions: 0o750 }),
    );
    this.addChild(
      admHome,
      this.mknode(".bashrc", "file", {
    ...
    this.addChild(
      srvReports,
      this.mknode("stability.log", "file", {
        content:
    ...
    this.addChild(
      varLogUnos,
      this.mknode("crystal.log", "file", {
        content: "[2026-01-28 00:00:02] Crystal data cache loaded\n",
      }),
    );
    this.addChild(
      varLogUnos,
      this.mknode("screwbutton.log", "file", {
        content:
    ...
    this.addChild(
      varLogUnos,
      this.mknode("network-sync.log", "file", {
        content:
  ...
  private formatLongEntry(node: VirtualNode): string {
    ...
    const name =
      node.type === "dir"
        ...
        : node.type === "symlink"
          ? `\x1b[35m${node.name} -> ${node.target}\x1b[0m`
          : (node.permissions & 0o111) !== 0
            ? `\x1b[32m${node.name}\x1b[0m`
            : node.name;
