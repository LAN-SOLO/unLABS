...
const screensaverCommand: Command = {
  ...
  usage: 'screensaver [pattern] [--list]  |  patterns: moire, lissajous, plasma, tunnel, spirograph, matrix, warp',
  execute: async (args) => {
    const validPatterns = ['moire', 'lissajous', 'plasma', 'tunnel', 'spirograph', 'matrix', 'warp']
