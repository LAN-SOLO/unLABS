...
import { PowerThermalBridge } from "@/contexts/PowerThermalBridge";
...
import { WindowSizeSelector } from "@/components/panel/modules/WindowSizeSelector";
...
export function PanelClient({ userId, username, balance, equipmentData }: PanelClientProps) {
  ...
  useEffect(() => {
    import("@/app/(game)/terminal/actions/panel-access").then(({ verifyPanelAccess }) => {
  ...
  if (!hasAccess) {
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-black">
        <div className="font-mono text-sm text-[var(--neon-amber)]">
                                                      ...
                                                      <CPUManagerProvider initialState={saved?.cpu}>
                                                        <CLKManagerProvider
                                                          initialState={
                                                            saved?.clk
                                                              ? {
                                                                  isPowered: saved.clk.isPowered,
                                                                  displayMode: saved.clk
                                                                    .displayMode as
                                                                    | CLKMode
                                                                    | undefined,
                                                                }
                                                        ...
                                                        >
                                                          <MEMManagerProvider
                                                            initialState={
                                                              saved?.mem
                                                                ? {
                                                                    isPowered: saved.mem.isPowered,
                                                                    totalMemory:
                                                                      saved.mem.totalMemory,
                                                                    usedMemory:
                                                                      saved.mem.usedMemory,
                                                                    displayMode: saved.mem
                                                                      .displayMode as
                                                                      | MEMMode
                                                                      | undefined,
                                                                  }
                                                                ...
                                                                saved?.and
                                                                  ? {
                                                                      isPowered:
                                                                        saved.and.isPowered,
                                                                      signalStrength:
                                                                        saved.and.signalStrength,
                                                                      anomaliesFound:
                                                                        saved.and.anomaliesFound,
                                                                      displayMode: saved.and
                                                                        .displayMode as
                                                                        | ANDMode
                                                                        | undefined,
                                                                    }
                                                                    ...
                                                                    ? {
                                                                        ...
                                                                        anomalyDirection:
                                                                          saved.qcp
                                                                            .anomalyDirection,
                                                                        anomalyDistance:
                                                                          saved.qcp.anomalyDistance,
                                                                        displayMode: saved.qcp
                                                                          .displayMode as
                                                                          | QCPMode
                                                                          | undefined,
                                                                      }
                                                                    ...
                                                                    saved?.tlp
                                                                      ? {
                                                                          isPowered:
                                                                            saved.tlp.isPowered,
                                                                          chargeLevel:
                                                                            saved.tlp.chargeLevel,
                                                                          lastDestination:
                                                                            saved.tlp
                                                                              .lastDestination,
                                                                          displayMode: saved.tlp
                                                                            .displayMode as
                                                                            | TLPMode
                                                                            | undefined,
                                                                        }
                                                                      ...
                                                                      saved?.lct
                                                                        ? {
                                                                            isPowered:
                                                                              saved.lct.isPowered,
                                                                            laserPower:
                                                                              saved.lct.laserPower,
                                                                            precision:
                                                                              saved.lct.precision,
                                                                            displayMode: saved.lct
                                                                              .displayMode as
                                                                              | LCTMode
                                                                              | undefined,
                                                                          }
                                                                                  ...
                                                                                  <PanelMain>
                                                                                    ...
                                                                                    <div className="flex min-h-0 flex-1 flex-col gap-1">
                                                                                      ...
                                                                                      <div className="border-t border-[var(--neon-green)]/20 pt-1">
                                                                                        <div className="mb-1 px-1 font-mono text-[7px] text-white/40">
                                                                                          CORE
                                                                                          OPERATIONS
                                                                                        </div>
                                                                                      ...
                                                                                      <div className="flex min-h-0 flex-1 flex-col border-t border-white/10 pt-1">
                                                                                        <div className="mb-0.5 flex items-center justify-between px-1">
                                                                                          <div className="flex items-center gap-1.5">
                                                                                            <span className="font-mono text-[6px] tracking-wider text-white/40">
                                                                                              RESEARCH
                                                                                              TREES
                                                                                            </span>
                                                                                            <div className="flex gap-0.5">
                                                                                              <div className="h-1 w-1 animate-pulse rounded-full bg-[var(--neon-green)]" />
                                                                                              <div className="h-1 w-1 rounded-full bg-[var(--neon-amber)]" />
                                                                                        ...
                                                                                        <div className="mb-[3px] grid grid-cols-4 gap-[3px]">
                                                                                          {(
                                                                                            [
                                                                                              {
                                                                                                name: "Tech",
                                                                                                  ...
                                                                                                  <div className="flex items-center gap-1 px-1 py-[3px]">
                                                                                                    ...
                                                                                                    <div className="min-w-0 flex-1">
                                                                                                      <div className="flex items-center justify-between">
                                                                                                        <span className="truncate font-mono text-[7px] text-white/70">
                                                                                                          {
                                                                                                            t.name
                                                                                                          }
                                                                                                        </span>
                                                                                                        <span
                                                                                                          className="shrink-0 font-mono text-[6px]"
                                                                                                          style={{
                                                                                                            color:
                                                                                                              isLocked
                                                                                                  ...
                                                                                                  <div className="flex items-center gap-1 px-1 py-[3px]">
                                                                                                    ...
                                                                                                    <div className="min-w-0 flex-1">
                                                                                                      <div className="flex items-center justify-between">
                                                                                                        ...
                                                                                                        <span
                                                                                                          className="shrink-0 rounded-[1px] px-[3px] font-mono text-[5px]"
                                                                                                          style={{
                                                                                                            color:
                                                                                                              isLocked
          ...
          <PanelFrame key={res.label} variant="default" className="p-1.5">
            ...
            <div className="mt-1 h-1.5 overflow-hidden rounded bg-black/50">
              <div
                ...
                style={{ width: `${pct * 100}%`, background: res.color }}
              />
            </div>
          </PanelFrame>
        );
...
function SystemPowerEffects() {
  const { systemState, countdownSeconds, countdownAction, onShutdownComplete, finishBoot } =
  ...
  const crtActive =
    isSystemScope && (systemState === "shutting-down" || systemState === "rebooting");
  ...
  return (
    <>
      ...
      {isOff && isSystemScope && <div className="fixed inset-0 z-[9999] bg-black" />}
    </>
  );
}
